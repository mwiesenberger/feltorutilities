...
# and thermaldiag creates the netcdf file at program start almost instantly

import json

import simplesimdb as simplesim

data = simplesim.Manager( directory="/m100_scratch/userexternal/mwiesenb/thermal3d", filetype = "nc")
diag = simplesim.Manager(
    executable="./thermaldiag.sh",
